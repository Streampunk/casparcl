...
function dumpBuf(buf, width, numLines) {
	...
	for (let l = 0; l < numLines; ++l) {
		...
		console.log(
			`Line ${l}: ${getBHex(0)}, ${getGHex(0)}, ${getRHex(0)}, ${getAHex(0)}; ${getBHex(
				1
			)}, ${getGHex(1)}, ${getRHex(1)}, ${getAHex(1)}; ${getBHex(2)}, ${getGHex(2)}, ${getRHex(
				2
			)}, ${getAHex(2)}; ${getBHex(3)}, ${getGHex(3)}, ${getRHex(3)}, ${getAHex(3)}`
		)
	}
}
