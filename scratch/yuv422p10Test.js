...
async function noden() {
  ...
  await srcs[0].hostAccess('writeonly', Buffer.from(yuv422p10Src.buffer, 0, lumaBytes));
  await srcs[1].hostAccess('writeonly', Buffer.from(yuv422p10Src.buffer, lumaBytes, chromaBytes));
  await srcs[2].hostAccess('writeonly', Buffer.from(yuv422p10Src.buffer, lumaBytes + chromaBytes, chromaBytes));
