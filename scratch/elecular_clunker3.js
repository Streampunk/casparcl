...
async function processFrame(context, params, clQueue) {
  ...
  for (let field=0; field<params.numFields; ++field) {
    ...
    processPromises.push(vidSwitcher.processFrame(
      [{ input: rgbaBG[field][s0], scale: scale0, offsetX: offset0, offsetY: 0.0, flipH: false, flipV: flipV0, rotate: rotate },
       { input: rgbaBG[field][s1], scale: scale1, offsetX: offset1, offsetY: 0.0, flipH: false, flipV: flipV1, rotate: rotate }],
